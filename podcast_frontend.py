...
def main():
    ...
    if process_button:
        ...
        cleaned_summary = re.sub(r'GUEST NAME: .*?GUEST TITLE: [a-ZA-Z\.]+', '', podcast_info['podcast_summary'])
        ...
        header_text = "Podcast Guest" if podcast_info['podcast_guest']['title'] != 'Host' else "Podcast Host"
...
def display_podcast_info(podcast_info):
    ...
    if match:
        cleaned_summary = match.group(1)
    else:
        cleaned_summary = podcast_info['podcast_summary']
